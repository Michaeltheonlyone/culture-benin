...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{ route('backend.contenus.create') }}" class="btn btn-primary float-end">Ajouter</a>
    </div>
    <div class="card-body">
        <table class="table table-bordered table-striped" id="contenusTable">
            <thead>
                <tr>
                    <th>Titre</th>
                    <th>Type Contenu</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $c->typeMedia->nom_media ?? '-' }}</td>
                    <td>{{ $c->region->nom_region ?? '-' }}</td>
                    <td>{{ $c->langue->nom_langue ?? '-' }}</td>
                    <td>{{ $c->auteur->prenom ?? '' }} {{ $c->auteur->nom ?? '-' }}</td>
                    <td class="text-center" style="white-space:nowrap">
                        <a href="{{ route('backend.contenus.show', $c->id) }}"
                        ...
                        <a href="{{ route('backend.contenus.edit', $c->id) }}"
                        ...
                        <form action="{{ route('backend.contenus.destroy', $c->id) }}" method="POST" style="display:inline">
                            @csrf @method('DELETE')
                            <button type="submit"
