...
<head>
    <meta charset="UTF-8">
    <title>Mon Profil | Portail Culturel du Bénin</title>
...
<!-- Fetch data if not provided by controller -->
@php
                ...
                <div class="pt-20 px-6 pb-6">
                    <div class="flex justify-between items-start">
                        ...
                        <a href="{{ route('profile.edit') }}"
                           class="px-5 py-2.5 border border-blue-600 text-blue-600 hover:bg-blue-50 rounded-lg font-semibold transition duration-300">
                            <i class="fas fa-edit mr-2"></i>Éditer le profil
                        </a>
                    </div>
            ...
            <div class="space-y-6">
                ...
                @empty
                    <div class="bg-white rounded-xl p-8 border border-gray-200 text-center">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2">Aucun contenu publié</h3>
                        <p class="text-gray-600 mb-4">Commencez à partager vos découvertes culturelles.</p>
                        <button onclick="openPostModal()"
                                class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg font-semibold transition duration-300">
